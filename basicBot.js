        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.songstats) {
                if (typeof basicBot.chat.songstatistics === "undefined") {
                    API.sendChat("/me :notes: " + lastplay.media.author + " - " + lastplay.media.title + ": " + lastplay.score.positive + " :thumbsup: " + lastplay.score.grabs + " :star: " + lastplay.score.negative + " :thumbsdown:")
                }
                else {
